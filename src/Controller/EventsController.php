...
class EventsController extends AbstractController
{
    ...
    #[Route('/type/{type}', name: 'app_events_type', methods: ['GET'])]
    public function music(string $type, EventsRepository $eventsRepository): Response
    {
        $events = $eventsRepository->findBy(['type' => $type]);
